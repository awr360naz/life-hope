// src/pages/KolShahr4_7kayatPage.jsx
...
export default function KolShahr4_7kayatPage() {
  ...
  return (
    <div className="cami-page wrap">
      <h2 className="cami-heading">كل شهر اربع حكايات</h2>
        ...
        <>
          <div className="cami-grid">
            {paginatedItems.map((it) => {
              const title = it.title ||  "كل شهر اربع حكايات";
              return (
                <button
                ...
                >
                  <div className="cami-thumb">
                    ...
                    <span className="cami-play" aria-hidden>▶</span>
                  </div>
                  <div className="cami-body">
                    <h3 className="cami-title" title={title}>{title}</h3>
                  </div>
                </button>
              );
            })}
          ...
          <div className="cami-pager">
            <button type="button" className="cami-btn nav-btn" disabled={page <= 1} onClick={() => setPage((p) => Math.max(1, p - 1))}>
              السابق
            </button>
            ...
            <button type="button" className="cami-btn nav-btn" disabled={page >= totalPages} onClick={() => setPage((p) => Math.min(totalPages, p + 1))}>
              التالي
            </button>
          </div>
        </>
