// src/components/WamdatRaw7yeCarousel.jsx
...
export default function WamdatRaw7yeCarousel({
  title = "ومضات روحية",
  perView = 4,
  step = 1,
  ...
  return (
    ...
    >
      <div className="programs-header">
        <h2 id="Wamdat-Raw7ye-title" className="programs-title">
          {title}
        </h2>
        {linkTo && (
