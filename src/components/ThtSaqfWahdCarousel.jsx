// src/components/ThtSaqfWahdCarousel.jsx
...
export default function ThtSaqfWahdCarousel({
  title = "تحت سقف واحد",
  perView = 4,
  step = 1,
  ...
  return (
    ...
    >
      <div className="programs-header">
        <h2 id="tht-saqf-wahd-title" className="programs-title">
          {title}
        </h2>
        {linkTo && (
